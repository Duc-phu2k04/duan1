                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($listdonhang as $donhang) :
                            extract($donhang);
                            // Đường dẫn đến các trang chi tiết, sửa, xóa đơn hàng
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $donhang['thoigian_mua'] ?></td> <!-- Thời gian mua -->
                                    <td><?= $donhang['soluong'] ?></td> <!-- Thời gian mua -->
                                    
                                  
                                    <td><?= $donhang['ten_trangthai'] ?></td> <!-- Trạng thái đơn hàng -->
                                    <td>
                                        ...
                                        <a href="<?= $xoadh ?>" onclick="return confirm('Bạn có muốn xóa không?')"><input type="button" class="form-control btn btn-danger mt-2" value="Xóa"></a>
                                    </td>
                                </tr>
                        <?php endforeach; ?>
                    </tbody>
